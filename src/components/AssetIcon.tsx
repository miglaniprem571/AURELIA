...
const AssetIcon = memo(function AssetIcon({ name, className = 'h-5 w-5', title, decorative = false }: AssetIconProps) {
  const commonProps = {
    className,
  ...
  switch (name) {
    case 'arrow-path':
      return (
        <svg {...commonProps} fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
    ...
    case 'cube-16-solid':
      return (
        <svg {...commonProps} fill="currentColor" viewBox="0 0 16 16">
    ...
    case 'search':
      return (
        <svg {...commonProps} fill="currentColor" viewBox="0 0 20 20">
    ...
    case 'chevron-up-solid':
      return (
        <svg {...commonProps} fill="currentColor" viewBox="0 0 24 24">
          <path d="M11.47 7.72a.75.75 0 0 1 1.06 0l7.5 7.5a.75.75 0 1 1-1.06 1.06L12 9.31l-6.97 6.97a.75.75 0 0 1-1.06-1.06l7.5-7.5Z" clipRule="evenodd" />
        </svg>
      );
    default:
      return null;
